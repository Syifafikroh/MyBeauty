                ...
                <div class="form-group full-width">
                    ...
                    <div class="editor-container">
                        ...
                        <div class="editor-content" id="editor" contenteditable="true" 
                             data-placeholder="Tulis konten artikel di sini..."></div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize editor
    editor.innerHTML = '<p>Tulis konten artikel di sini...</p>';

    // Handle editor focus
    editor.addEventListener('focus', function() {
        if (this.innerHTML === '<p>Tulis konten artikel di sini...</p>') {
            this.innerHTML = '';
        }
    });
    ...
    editor.addEventListener('blur', function() {
        if (this.innerHTML.trim() === '' || this.innerHTML === '<p><br></p>') {
            this.innerHTML = '<p>Tulis konten artikel di sini...</p>';
        }
    });
    ...
    document.getElementById('articleForm').addEventListener('submit', function(e) {
        ...
        // Validate content
        if (!content || content === '<p>Tulis konten artikel di sini...</p>' || content === '<p><br></p>') {
            e.preventDefault();
